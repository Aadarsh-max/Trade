...
const LoginForm = () => {
  ...
  return (
    ...
    >
      <h1 className="text-2xl font-medium text-textPrimary mb-1">Welcome back</h1>
      <p className="text-textSecondary text-sm mb-8">Log in to continue trading</p>
      ...
      <p className="text-textSecondary text-sm text-center mt-6">
        ...
        <Link to="/signup" className="text-accent hover:text-accentStrong transition-colors">
          Sign up
        </Link>
      </p>
    </motion.form>
